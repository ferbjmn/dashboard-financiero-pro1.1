...
def main():
    ...
    if st.button("🔍 Analizar Acciones", type="primary"):
        ...
        if resultados:
            ...
            porcentajes = ["Dividend Yield %", "Payout Ratio", "ROA", "ROE", "Current Ratio", "Oper Margin", "Profit Margin", "WACC", "ROIC", "Eva"]
            ...
            columnas_mostrar = [
                ...
                "Dividend Yield %", "Payout Ratio", "ROE", "ROA", "Current Ratio", "Debt/Eq", "Oper Margin", "Profit Margin", "WACC", "ROIC", "Eva"]
